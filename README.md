...
<img width="1437" height="994" alt="image" src="https://github.com/user-attachments/assets/40156871-7a8b-4b25-a4e3-5566fddf01f4" />

# RESULT:
Thus the smart contract that integrates AI logic for automated negotiation in decentralized commerce. The contract adjusts price and conditions dynamically based on real-time market trends using an on-chain AI model.
